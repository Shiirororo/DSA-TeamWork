...
from frontend.screens.user_management_screen import UserManagementScreen
...
class App(ctk.CTk):
    ...
    def show_frame(self, frame_class, **kwargs):
        ...
        # Luôn truyền 'app' (chính là self) vào các màn hình
    ...
    def show_user_management_screen(self):
        """Hiển thị màn hình quản lý người dùng."""
